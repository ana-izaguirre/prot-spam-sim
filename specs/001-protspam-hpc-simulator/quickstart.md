...
3. Edit S1 to `AAAA` and press _Recompute_; the run regenerates from step 0.
...
1. Heterogeneous dataset, P = 32, cyclic: one rank is clearly taller, the imbalance KPI is
   above 2×, and the log warns about _Homo sapiens_.
...
3. Advance to the synchronisation step: every request reads _completed_.
